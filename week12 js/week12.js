...
const makeFour = () => {
	...
	resultFour.textContent = division;
	//Ваш код
};
...
const makeFive = () => {
	const num = 3;
	const power = 4;
	const degree = Math.pow(num,power);
	resultFive.textContent = degree;
	//Ваш код
};
...
const makeThirteen = () => {
	...
	resultThirteen.textContent = strLenght; 
	//Ваш код
};
...
const makeSixteen = () => {
	...
	resultSixteen.textContent = subStr; 
	//Ваш код
};
...
const makeSeventeen = () => {
	...
	resultSeventeen.textContent = subStr; 
	//Ваш код
};
...
const makeEighteen = () => {
  ...
  const replaseStr = str.replace("world","JavaScript");
	resultEighteen.textContent = replaseStr; 
	//Ваш код
};
...
const makeNineteen = () => {
	...
	resultNineteen.textContent = res; 
	//Ваш код
...
const makeTwentyOne = () => {
	...
	resultTwentyOne.textContent = rand;
};
...
const makeTwentyThree = () => {
	...
	const b = 5;
	const degree = 2**5;
	resultTwentyThree.textContent = degree;
	//Ваш код
};
...
const makeTwentySix = () => {
	...
	resultTwentySix.textContent = rand.toFixed(4);
	//Ваш код
};
...
const makeTwentySeven = () => {
	...
	resultTwentySeven.textContent = rand;
	//Ваш код
};
...
const makeTwentyEight = () => {
	const a = 4.47;
	const b = Math.ceil(a);
	resultTwentyEight.textContent = b;
	//Ваш код
};
...
const makeTwentyNine = () => {
	const a = 16;
	const b = Math.sqrt(a);
	resultTwentyNine.textContent = b;
	//Ваш код
};
